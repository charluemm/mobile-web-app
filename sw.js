    ...
    event.waitUntil(
        caches.open(VERSION).then(function(cache) {
            return cache.addAll([
                ...
                '/task-notification/vendor/font-awesome/fonts/fontawesome-webfont.ttf',
                '/task-notification/vendor/font-awesome/fonts/fontawesome-webfont.woff',
                '/task-notification/vendor/font-awesome/fonts/fontawesome-webfont.woff2',
                ...
                '/task-notification/resources/css/nativedroid2.css',
                '/task-notification/resources/css/nativedroid2.color.blue-grey.css',
                '/task-notification/resources/css/nativedroid2.color.teal.css',
                '/task-notification/resources/css/flexboxgrid.min.css',
                '/task-notification/resources/css/material-design-iconic-font.min.css',
                ...
                '/task-notification/resources/js/nativedroid2.js',
